...
$.extend(ImageSelector.prototype,{$el:null,$container:null,$zone:null,$remove:null,$dummyFileInput:null,busy:!1,defaultImage:null,init:function(){this.$el=$(this.element).hide();var defaultImage=this.$el.data('default-image');if(defaultImage){this.settings.defaultImage=defaultImage}
